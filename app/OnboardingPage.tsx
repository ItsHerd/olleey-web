          ...
          <div className="flex items-center justify-between relative">
            ...
            {[1, 2, 3, 4].map((step) => (
              <div key={step} className="relative z-10 flex flex-col items-center">
                <div
                  className={`w-10 h-10 rounded-full border-2 flex items-center justify-center text-sm font-normal transition-all ${step < currentStep
                ...
                <span className={`mt-2 text-xs font-medium ${step <= currentStep ? "text-gray-900" : "text-dark-textSecondary"
                  }`}>
                  ...
                  <div className="flex gap-3">
                    {(["strict", "loose"] as const).map((option) => (
                      <button
                        ...
                        className={`flex-1 px-4 py-3 rounded-xl font-medium border-2 transition-all ${toneMatch === option
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {(["genz", "professional", "neutral"] as const).map((option) => (
                      <button
                        ...
                        className={`px-4 py-3 rounded-xl font-medium border-2 transition-all ${vocabulary === option
                            ? "bg-indigo-50 border-indigo-600 text-indigo-900"
                            : "bg-white border-gray-200 text-gray-700 hover:border-gray-300"
                          }`}
                      >
