...
export default function AnalyticsPage() {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-normal text-[#111827] mb-2">Analytics</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg border border-[#e5e7eb] p-6">
          ...
          <p className="text-3xl font-normal text-[#111827] mb-1">124.5M</p>
        ...
        <div className="bg-white rounded-lg border border-[#e5e7eb] p-6">
          ...
          <p className="text-3xl font-normal text-[#111827] mb-1">68.2M</p>
        ...
        <div className="bg-white rounded-lg border border-[#e5e7eb] p-6">
          ...
          <p className="text-3xl font-normal text-[#111827] mb-1">3,842</p>
        ...
        <div className="bg-white rounded-lg border border-[#e5e7eb] p-6">
          ...
          <p className="text-3xl font-normal text-[#111827] mb-1">16</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg border border-[#e5e7eb] p-6">
          <h2 className="text-lg font-normal text-[#111827] mb-4">Channel Performance</h2>
        ...
        <div className="bg-white rounded-lg border border-[#e5e7eb] p-6">
          <h2 className="text-lg font-normal text-[#111827] mb-4">Top Languages by Views</h2>
