            ...
            <div>
              ...
              <div className="mt-2 flex gap-3">
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-normal border transition-colors ${
                    theme === "light"
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  notifications.email ? "bg-indigo-500" : cardAltClass
                }`}
              >
                <span
            ...
            <label className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  notifications.distribution ? "bg-indigo-500" : cardAltClass
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <label className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  notifications.errors ? "bg-indigo-500" : cardAltClass
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    experimentalFeatures.aiVoiceCloning ? "bg-indigo-500" : cardAltClass
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      experimentalFeatures.aiVoiceCloning ? "translate-x-6" : "translate-x-1"
                    }`}
                  />
                </button>
              </label>
              ...
              <label className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    experimentalFeatures.autoTranslation ? "bg-indigo-500" : cardAltClass
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      experimentalFeatures.autoTranslation ? "translate-x-6" : "translate-x-1"
                    }`}
                  />
                </button>
              </label>
              ...
              <label className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    experimentalFeatures.advancedAnalytics ? "bg-indigo-500" : cardAltClass
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <label className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    experimentalFeatures.betaFeatures ? "bg-indigo-500" : cardAltClass
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      experimentalFeatures.betaFeatures ? "translate-x-6" : "translate-x-1"
                    }`}
                  />
                </button>
              </label>
