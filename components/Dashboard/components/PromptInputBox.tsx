...
import { ArrowUp, Paperclip, Square, X, StopCircle, Mic, Globe, BrainCog, FolderCode, ChevronDown, Plus, FolderOpen } from "lucide-react";
...
const CustomDivider: React.FC = () => (
    <div className="relative h-6 w-[1.5px] mx-1">
        <div
            className="absolute inset-0 bg-gradient-to-t from-transparent via-[#D97757]/70 to-transparent rounded-full opacity-30"
        />
    </div>
);
    ...
    return (
        <>
            ...
            >
                                ...
                                {file.type.startsWith("image/") && filePreviews[file.name] && (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="absolute top-1 right-1 rounded-full bg-black/70 p-1 opacity-100 transition-opacity border border-white/10"
                                        >
                ...
                <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-4">
                    <div
                        className={cn(
                    ...
                    >
                        ...
                        <div className="hidden md:flex items-center">
                            <button
                                ...
                                className={cn(
                                    "rounded-full transition-all flex items-center gap-1 px-2.5 py-1.5 border h-9",
                                    showSearch
                                ...
                                <AnimatePresence>
                                    {showSearch && (
                                        <motion.span
                                            ...
                                            className="text-xs overflow-hidden whitespace-nowrap text-[#1EAEDB]"
                                        >
                                            Search
                                        </motion.span>
                                    )}
                            ...
                            >
                                <BrainCog className={cn("w-4 h-4", showThink ? "text-[#D97757]" : "text-inherit")} />
                                <AnimatePresence>
                                    {showThink && (
                                        <motion.span
                                            initial={{ width: 0, opacity: 0 }}
                                            ...
                                            exit={{ width: 0, opacity: 0 }}
                                            transition={{ duration: 0.2 }}
                                            className="text-xs overflow-hidden whitespace-nowrap text-[#D97757]"
                                        >
                                            Think
                                        </motion.span>
                                    )}
                                ...
                                <AnimatePresence>
                                    {showCanvas && (
                                        <motion.span
                                            ...
                                            exit={{ width: 0, opacity: 0 }}
                                            transition={{ duration: 0.2 }}
                                            className="text-xs overflow-hidden whitespace-nowrap text-[#F97316]"
                                        >
                                            Canvas
                                        </motion.span>
                                    )}
                        ...
                        <Button
                            ...
                            className={cn(
                                ...
                                isRecording
                                    ...
                                    : hasContent
                                        ? "bg-[#D97757] hover:bg-[#D97757]/90 text-white shadow-[#D97757]/20 shadow-lg"
