                        ...
                        {activeVideos.map((video, idx) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className={`relative w-32 aspect-video rounded-2xl overflow-hidden ${isDark ? 'bg-black/40' : 'bg-gray-200'} shrink-0 border ${isDark ? 'border-white/10' : 'border-gray-300'} group-hover:scale-[1.02] transition-transform duration-500`}>
                                        {video.thumbnail_url ? (
                                            <img
                                        ...
                                        <div className="flex flex-wrap items-center gap-3">
                                            {isProcessing ? (
                                                ...
                                                <div className={`px-3 py-1.5 rounded-xl border flex items-center gap-2 ${isReview
                                                    ...
                                                    <span className="text-[10px] font-black uppercase tracking-widest">{isReview ? 'Review Protocol' : status === LocalizationStatus.NOT_STARTED ? 'Awaiting Review' : 'Staged for Ingestion'}</span>
                                                </div>
                                            )}
                                    ...
                                    {/* Action Indicator */}
                                    {!isProcessing && (
                                        <div className={`shrink-0 ${isDark ? 'text-white/20 group-hover:text-olleey-yellow' : 'text-gray-300 group-hover:text-olleey-yellow'} transition-all duration-300 transform group-hover:translate-x-1`}>
