...
export default function Footer({ onGetStarted }: { onGetStarted?: () => void }) {
  ...
  return (
    <footer className="relative border-t border-white/10 bg-black transition-colors duration-300 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none opacity-[0.08] [background-image:radial-gradient(currentColor_1px,transparent_1px)] [background-size:20px_20px]" />
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
          <div className="max-w-md">
            <div className="flex items-center gap-3">
              <div className="relative w-11 h-11 rounded-full bg-white/10 p-2">
                <Image src="/favicon/android-chrome-192x192.png" alt="Olleey Logo" fill className="object-contain" />
              </div>
              <span className="text-xl tracking-tight text-zinc-100">olleey</span>
            </div>
