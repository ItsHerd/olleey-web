  ...
  return (
    <>
      <section id="product" className="py-24 bg-white dark:bg-black border-t border-black/10 dark:border-white/10 relative overflow-hidden transition-colors duration-300">
        <div
          className="absolute inset-0 z-0 opacity-5 dark:opacity-0 transition-opacity duration-300"
          style={{
        ...
        />
        <div
          className="absolute inset-0 z-0 opacity-0 dark:opacity-10 transition-opacity duration-300"
          style={{
